...
public class EvaluateLogServiceImpl implements IEvaluateLogService {
	...
	@Override
	public void evaluateLog(DxccEntity mexicoDxccEntity, Long logId, Integer conteoId) {
		...
		evaluateService.findForErrorsOnQsosOfLog(mexicoDxccEntity, contestLog, conteo);
	}
}