...
public class BandController extends BaseController{/**
	 * 
	 */
	private static final long serialVersionUID = -6606386365538444863L;
	
	@Autowired private IBandService bandService;

	@GetMapping
	public ResponseEntity<StdResponse> getAll() {
		try {
			getResponseServiceVo().setData(bandService.getAll());
